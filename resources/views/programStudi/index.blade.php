                ...
                <div class="card-style mb-30">
                    <div class="header-left d-flex align-items-center justify-content-between mb-4">
                        <div class="menu-toggle-btn mr-15">
                            <a href="{{ route('programStudi.create') }}" id="menu-toggle"
                    ...
                    <div class="table-wrapper table-responsive">
                        <table class="table">
                            ...
                            @foreach($programStudi as $studi)
                                <tr>
                                    <td class="min-width">
                                        <p class="text-capitalize">{{ $studi->id}}</p>
                                    </td>
                                  
                                    <td class="min-width">
                                        <p class="text-capitalize">{{ $studi->name }}</p>
                                    </td>
                                    <td>
                                        <div class="action">
                                            <a class="text-success" href="{{ route('programStudi.edit', $studi->id) }}">
